    ...
    <div className="min-h-[calc(100vh-68px)] flex items-center justify-center bg-paper-100/40 px-5 py-16">
      ...
      >
        <div className="flex flex-col items-center mb-7">
          ...
          <h1 className="font-display text-2xl text-paper-950">Welcome back</h1>
          <p className="text-sm text-paper-700 mt-1">Log in to manage and book your stays.</p>
        </div>
        ...
        <p className="text-center text-sm text-paper-700 mt-6">
          New to Meridian Stay?{' '}
          <Link to="/signup" className="text-meridian-800 font-semibold hover:text-meridian-900">
            Create an account
          </Link>
        </p>
      </motion.div>
